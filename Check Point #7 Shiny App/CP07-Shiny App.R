...
ui <- fluidPage(
  ...
  tags$div(class = "goal-box",
           ...
           tags$strong("Methods: "),
           "Exploratory data analysis using descriptive statistics, one-way ANOVA, and multiple visualization techniques including boxplots, trend lines, heatmaps, and correlation analysis.", br(),
           ...
           "This app explores how renewable natural gas (RNG) production relates to organic inputs and
     system variables. Use the controls to select a ", tags$strong("chart type"),
           ", choose an ", tags$strong("outcome variable"), ", and adjust the ",
           
           tags$strong("grouping factor"), ". Press ", tags$strong('"Run Analysis"'),
           " to update all visuals and statistics.",br(),
          
           tags$strong("AI Disclosure: "),
           "This project was developed with assistance from ChatGPT for coding and design support. All outputs were reviewed and validated by the author."
...
server <- function(input, output, session) {
  ...
  output$anova <- renderPrint({
    ...
    else               cat("  No significant group differences  (p =", round(p,4), ")\n")
  })
}
